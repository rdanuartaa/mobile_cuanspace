...
class _ExploreState extends State<Explore> {
  int _selectedIndex = 1; // Default to Explore tab
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      case 0:
        ...
        break;
      case 1:
        // Already on Explore, no navigation needed
        break;
      case 2:
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Jelajahi', style: TextStyle(fontFamily: 'Poppins', color: Colors.white, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
      body: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.explore, size: 100, color: Colors.orange),
            SizedBox(height: 20),
            Text(
              'Jelajahi Menu',
